...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/20 bg-[#87A0AB] text-white">
      <Container className="flex flex-col gap-6 py-10 md:flex-row md:items-center md:justify-between">
        <div className="flex w-full flex-col items-center text-sm text-white/85 md:w-auto">
          <div className="flex items-center gap-3">
            <span className="relative h-16 w-[21rem] sm:h-20 sm:w-[27rem]">
              <Image
          ...
          <div className="mt-4 flex w-full max-w-[21rem] items-center justify-center gap-4 sm:max-w-[27rem]">
            {SITE.socialNav.map((item) => (
              <a
                key={item.network}
                href={item.href}
                target="_blank"
